                  ...
                  <AnimatedCard key={product.id} index={idx}>
                    ...
                    >
                      ...
                      <div className="relative aspect-[4/3] bg-gray-50 img-zoom">
                        ...
                        {/* Category badge */}
                        <span className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-white/90 backdrop-blur-sm text-primary text-[10px] sm:text-xs font-bold px-2 sm:px-3 py-0.5 sm:py-1 rounded-full shadow-sm">
                          {product.category}
                        </span>
                      </div>
